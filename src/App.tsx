...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <footer className="footer"><span>LOCAL AI · NO PROJECT FILE ACCESS</span><span>{project?.repository ? `${project.repository.branch} · ${project.repository.changedFiles ? `${project.repository.changedFiles} changed` : 'Clean'}` : 'No project open'}</span></footer>
  </div>
}
